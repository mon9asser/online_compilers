...
const restrictedModules =  ['fs', 'child_process', 'child_process.promises', 'os', 'process']
const restrictedPatterns = [/exec\(/, /spawn\(/, /rm/, /npm/, /git/, /forever/, /killall/, /kill/, /fkill/, /taskkill/, /nodemon/, /node/, /cat/, /cd/];
